                    ...
                    if (iframe.contains("playm4u")) {
                        ...
                        if (!html.isNullOrEmpty()) {
                            ...
                            if ( idfile.isNotEmpty() && idUser.isNotEmpty()) {
                                ...
                                var json = String.format("{\"idfile\":\"%s\",\"iduser\":\"%s\",\"domain_play\":\"%s\",\"platform\":\"%s\",\"hlsSupport\":true,\"jwplayer\":{\"Browser\":{\"androidNative\":false,\"chrome\":true,\"edge\":false,\"facebook\":false,\"firefox\":false,\"ie\":false,\"msie\":false,\"safari\":false,\"version\":{\"version\":\"129.0.0.0\",\"major\":129,\"minor\":0}},\"OS\":{\"android\":false,\"iOS\":false,\"mobile\":false,\"mac\":true,\"iPad\":false,\"iPhone\":false,\"windows\":false,\"tizen\":false,\"tizenApp\":false,\"version\":{\"version\":\"10_15_7\",\"major\":10,\"minor\":15}},\"Features\":{\"iframe\":true,\"passiveEvents\":true,\"backgroundLoading\":true}}}",idfile_dec,idUser_dec,domain_ref,plf,plf)
                                ...
                                html = httpHelper.post(
                                    ...
                                    data = mapOf(
                                       ...
                                       // "referrer" to "$BASE_URL/",
                                        "data" to (data + "|"  + MD5Utils.StringtoHex(data + "KRWN3AdgmxEMcd2vLN1ju9qKe8Feco5h").toString())
                                    ),
                                    headers = hashMap1
                                ).text
                            }
