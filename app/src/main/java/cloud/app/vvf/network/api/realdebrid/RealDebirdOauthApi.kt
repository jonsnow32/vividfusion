...
interface RealDebridOauthApi {
    ...
    fun oauthDeviceCode(@Query("client_id") extensionId: String = "X245A4XAIBGVM"): Call<RealDebridGetDeviceCodeResult>

    @GET("oauth/v2/device/credentials")
    fun oauthDeviceCredentials(
        @Query("client_id") extensionId: String = "X245A4XAIBGVM",
