package cloud.app.vvf.extension.tmdb
...
import cloud.app.vvf.extension.tmdb.services.tmdb.AppTmdb
import cloud.app.vvf.extension.tmdb.services.tmdb.SearchSuggestion
import cloud.app.vvf.extension.tmdb.services.tmdb.companies
import cloud.app.vvf.extension.tmdb.services.tmdb.formatSeasonEpisode
import cloud.app.vvf.extension.tmdb.services.tmdb.iso8601ToMillis
import cloud.app.vvf.extension.tmdb.services.tmdb.languageI3691Map
import cloud.app.vvf.extension.tmdb.services.tmdb.model.WatchProviders
import cloud.app.vvf.extension.tmdb.services.tmdb.model.WatchProviders.WatchProvider
import cloud.app.vvf.extension.tmdb.services.tmdb.movieGenres
import cloud.app.vvf.extension.tmdb.services.tmdb.networks
import cloud.app.vvf.extension.tmdb.services.tmdb.popularCountriesIsoToEnglishName
import cloud.app.vvf.extension.tmdb.services.tmdb.showGenres
import cloud.app.vvf.extension.tmdb.services.tmdb.toMediaItem
import cloud.app.vvf.extension.tmdb.services.tmdb.toMediaItemsList
import cloud.app.vvf.extension.tmdb.services.trakt.AppTrakt
import cloud.app.vvf.extension.tmdb.services.tvdb.AppTheTvdb
...
@VVFExtension
class TmdbTvdbClient : DatabaseClient, StreamClient, HttpHelperProvider, MessageFlowProvider {
  ...
  companion object {
    ...
    val metadata = ExtensionMetadata(
      ...
      description = "This is insalled Apk Debug Sample Extension\n" +
        "-> Database uses the TMDb and TheTVDB but is not endorsed or certified by TMDb or TheTVDB. These services are licensed under CC BY-NC 4.0: https://creativecommons.org/licenses/by-nc/4.0",
      version = "1.0.0",
      author = "Avp",
      iconUrl = "data:image/png;base64,",
